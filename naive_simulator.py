...
#         passgen = ParamPassGen()
#         passgen.set_param(lbd=lbd_vec, car_num=c_num)
#         for i in range(r_num):  # event heap init
#             event_manager.enqueue(passgen.get_passenger(i))
...
#                 event_manager.enqueue(passgen.get_passenger(event.dest))
